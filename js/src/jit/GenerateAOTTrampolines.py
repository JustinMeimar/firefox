...
def main(c_out, bin_path):
    """
    Reads the raw trampoline binary and wraps it in "platform-agnostic assembly"
    ...
    with open(bin_path, 'rb') as f_in:
        ...
        c_out.write(".global trampoline_blob_start\n")
        c_out.write(".global trampoline_blob_end\n")
        c_out.write(".balign 16\n")
        c_out.write("trampoline_blob_start:\n")
        directive = ".byte"
        ...
        c_out.write("trampoline_blob_end:\n")
