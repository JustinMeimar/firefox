...
#define ABIFUNCTION_AND_SYMBOL_LIST(_)                               \
  ...
  _(js::ArraySortData::sortTypedArrayWithComparator, sortTypedArrayWithComparator)                           \
  ...
  _(js::irregexp::CaseInsensitiveCompareNonUnicode, CaseInsensitiveCompareNonUnicode)                            \
  _(js::irregexp::CaseInsensitiveCompareUnicode, CaseInsensitiveCompareUnicode)                               \
  ...
  _(js::jit::BigIntNumberEqual<js::jit::EqualityKind::Equal>, BigIntNumberEqual_Equal)                  \
  _(js::jit::BigIntNumberEqual<js::jit::EqualityKind::NotEqual>, BigIntNumberEqual_NotEqual)               \
  _(js::jit::BigIntNumberCompare<js::jit::ComparisonKind::LessThan>, BigIntNumberCompare_LT)           \
  _(js::jit::NumberBigIntCompare<js::jit::ComparisonKind::LessThan>, NumberBigIntCompare_LT)           \
  _(js::jit::NumberBigIntCompare<js::jit::ComparisonKind::GreaterThanOrEqual>, NumberBigIntCompare_GTE) \
  _(js::jit::BigIntNumberCompare<js::jit::ComparisonKind::GreaterThanOrEqual>, BigIntNumberCompare_GTE) \
  ...
  _(js::jit::GetContextSensitiveInterpreterStub, GetContextSensitiveInterpreterStub)                               \
  ...
  _(js::jit::GetNativeDataPropertyPureWithCacheLookup, GetNativeDataPropertyPureWithCacheLookup)                         \
  _(js::jit::GetNativeDataPropertyByValuePure, GetNativeDataPropertyByValuePure)                                 \
  _(js::jit::GlobalHasLiveOnDebuggerStatement, GlobalHasLiveOnDebuggerStatement)                                 \
  ...
  _(js::jit::HasNativeDataPropertyPure<false>, HasNativeDataPropertyPure_false)                                 \
  ...
  _(js::TypedArraySetFromSubarrayInfallible, TypedArraySetFromSubarrayInfallible) \
  ...
  _(js::jit::JitValuePreWriteBarrier, JitValuePreWriteBarrier)                    \
  _(js::jit::JitStringPreWriteBarrier, JitStringPreWriteBarrier)                  \
  _(js::jit::JitObjectPreWriteBarrier, JitObjectPreWriteBarrier)                  \
  _(js::jit::JitShapePreWriteBarrier, JitShapePreWriteBarrier)                    \
  _(js::jit::JitWasmAnyRefPreWriteBarrier, JitWasmAnyRefPreWriteBarrier)
#endif

#define ABIFUNCTION_AND_SYMBOL_AND_TYPE_LIST(_)         \
  _(JS::ToInt32, ToInt32, int32_t (*)(double))          \
  _(js::jit::RoundFloat16ToFloat32, RountFloat16ToFloat32_int32, float (*)(int32_t)) \
  _(js::jit::RoundFloat16ToFloat32, RountFloat16ToFloat32_float, float (*)(float))   \
  _(js::jit::RoundFloat16ToFloat32, RountFloat16ToFloat32_double, float (*)(double))
...
// Define the linker symbols for each ABI function.
#ifdef JS_SPASM
#define DEF_TEMPLATE(fp, sym)                         \
  template <>                                         \
  struct ABIFunctionSymbolData<decltype(&fp), fp> {   \
    static constexpr bool registered = true;          \
    static constexpr const char* const symbol = #sym; \
  };
...
#define DEF_TEMPLATE(fp, sym, ...)                \
  template <>                                \
  struct ABIFunctionSymbolData<__VA_ARGS__, fp> {  \
    static constexpr bool registered = true; \
    static constexpr const char* const symbol = #sym; \
  };
