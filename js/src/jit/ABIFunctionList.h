...
#ifndef jit_ABIFunctionList_h
#define jit_ABIFunctionList_h

// Text-only macro definitions for the callWithABI function list. The
// declarations these entries resolve to live in ABIFunctionList-inl.h; callers
// that just need to expand the list into a shape (an element count, a slot
// table, etc.) can include this header instead and skip the pull-in.
